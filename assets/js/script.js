...
function sendMail() {
  ...
  const serviceID = "service_vxafs3w";
  const templateID = "template_b5uktlg";
...
function popMail() {
  ...
  var confirm = document.getElementById("recipientConfirm").value;
  ...
  const serviceID = "service_vxafs3w";
  const templateID = "template_cz5awxe";
  ...
  emailjs
    ...
    .then((res) => {
      ...
      document.getElementById("recipientConfirm").value = "";
